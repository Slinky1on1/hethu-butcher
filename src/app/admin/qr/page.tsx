...
export default async function QRPage() {
  await requireOwner();
  const orderUrl = `${businessConfig.appUrl}/order`;
    ...
    <div className="min-h-screen bg-hethu-cream pb-8">
      ...
      <div className="space-y-4 p-4 text-center">
        ...
        <div className="rounded-2xl bg-white p-4">
          <p className="text-sm text-gray-500">Order link</p>
        ...
        <div className="rounded-2xl border-2 border-dashed border-gray-300 p-4 text-sm text-gray-500">
          <p className="font-bold text-gray-700">Tip for Hethu</p>
          <p className="mt-2">
            Add to Home Screen: open this site in Chrome → menu (⋮) → &quot;Add to Home
            screen&quot;. Works like an app!
          </p>
        </div>
      </div>
    </div>
