...
export function OrderForm({ products }: { products: ProductItem[] }) {
  ...
  function goToCheckout() {
    if (!form.customerName.trim()) {
      setNameError("Please add your name so Hethu knows who ordered");
      return;
    }
    setNameError("");
    setStep("checkout");
        ...
        <form onSubmit={handleSubmit} className="space-y-4 p-4">
          <div className="rounded-2xl border-2 border-hethu-red bg-white p-4">
            ...
            <p className="mt-2 text-xs text-gray-500">
              So Hethu knows who placed this order
            </p>
          </div>
          <div>
          ...
          {paymentMethod === "eft" && (
            <div className="rounded-xl border-2 border-blue-200 bg-blue-50 p-4 text-sm">
              ...
              <p className="mt-2 text-blue-800">Bank: {businessConfig.bank.name}</p>
              <p className="text-blue-800">Account: {businessConfig.bank.accountName}</p>
              <p className="text-blue-800">Number: {businessConfig.bank.accountNumber}</p>
              <p className="text-blue-800">Branch: {businessConfig.bank.branch}</p>
  ...
  return (
    <div className="min-h-screen bg-hethu-cream pb-28">
      ...
      <div className="px-4 py-2 space-y-2">
        ...
        <div className="rounded-2xl border-2 border-hethu-red bg-white p-4 shadow-sm">
          ...
          <p className="mt-1 text-xs text-gray-500">
            Hethu needs your name to know who placed the order
          </p>
          {nameError && (
      ...
      <p className="pb-24 pt-4 text-center">
        <a href="/admin/login" className="text-xs text-gray-400">
          Owner login
        </a>
      </p>
    </div>
